...
if ($(function() {
        ...
        $("#jsBtnIdolCtrl a").each(function(o, i) {
            ...
            b || (b = !0, $("#commentLoading").show(), 500 === o || 501 === o ? ($("#loadingImage").attr("src", L), $("#loadingAmi").hide(), $("#loadingNormal").show()) : ($("#loadingImage").attr("src", M[Math.floor(Math.random() * M.length)]), $("#loadingAmi").hide(), $("#loadingNormal").show())
            B[l][S].comment_column_num = rand(1,5);
            function() {
