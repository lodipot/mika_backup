(function(a, n) {
    ...
    f.nominalBounds = new a.Rectangle(0, 0, 480,
        122);
    ...
    (b.dark = function(c, d, e) {
        ...
        h(b.dark, new a.Rectangle(-120, -155, 240, 310), null);
    ...
    }).prototype = h(b.place_name, new a.Rectangle(0,
        0, 191, 28.8), null);
    ...
    (b.obj2 = function(c, d, e) {
        ...
        this.timeline.addTween(a.Tween.get(this.shape).wait(1))
    }).prototype = h(b.obj2, new a.Rectangle(-148.1, -2.9,
    ...
    (b.loading_G = function(c, d, e) {
        ...
        h(b.loading_G, new a.Rectangle(-7.3, -11.4, 14.7, 22.9), null);
    ...
    (b._kira = function(c, d, e) {
        ...
        h(b._kira, new a.Rectangle(-10, -10, 20, 20), null);
    ...
    (b.bg_img4 = function(c, d, e) {
        ...
        this.instance.setTransform(-480, -310);
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    }).prototype = h(b.bg_img4, new a.Rectangle(-480, -310, 960, 620),
        null);
    ...
    (b.bg_img2 = function(c, d, e) {
        ...
        this.instance.setTransform(-480, -310);
        this.timeline.addTween(a.Tween.get(this.instance).wait(1))
    }).prototype = h(b.bg_img2, new a.Rectangle(-480,
        -310, 960, 620), null);
    ...
    f.nominalBounds = new a.Rectangle(-10,
        -1.4, 260, 35.9);
    ...
    (b.particle_flash1 = function(c, d, e) {
        ...
        this.instance = new b.particle_flash_core;
        this.instance.parent = this;
        this.instance.setTransform(19.95, -4.05,
            .7347, .7347);
        this.timeline.addTween(a.Tween.get(this.instance).wait(1).to({
            regX: -.2,
            regY: .5,
    ...
    (b.particle_flash_container = function(c, d, e) {
        ...
        this.instance_7.parent = this;
        this.instance_7.setTransform(36, 16.45, 1.1194, 1.0589, 0, -118.0587,
            42.7302);
        ...
        this.instance_11.setTransform(2.25, 20.95,
            .5292, .5292, 134.5199);
        ...
        this.instance_22.setTransform(-14.65, 19.6, .5925, .5292,
            0, -72.0065, 107.9921);
    ...
    }).prototype = h(b.particle_flash_container, new a.Rectangle(-55.4, -47.8, 121.80000000000001,
        129.8), null);
    ...
    (b.square2c = function(c, d, e) {
        ...
        this.instance_8.parent = this;
        this.instance_8.setTransform(.7,
            .7, 1, 1, 0, 0, 0, .7, .7);
        this.timeline.addTween(a.Tween.get({}).to({
            state: [{
                t: this.instance_8
    ...
    f.nominalBounds = new a.Rectangle(-82.9,
        -80.5, 444.6, 570);
    ...
    (b.story_generator_n1 = function(c, d, e) {
        ...
        this.frame_0 = function() {
            ...
            for (var t = 1; t <= exportRoot.chara_num; t++) exportRoot["chara_" + t].chara.gotoAndStop(0), exportRoot["chara_" + t].chara.body.gotoAndStop(0), exportRoot["chara_" + t].chara.body.black.visible = !1, exportRoot["chara_b_" + t].chara.gotoAndStop(0), exportRoot["chara_b_" + t].chara.body.gotoAndStop(0), exportRoot["chara_b_" + t].chara.body.black.alpha = .45;
            ...
            exportRoot._u = {
                ...
                chara_back_set: function(g) {
                    for (g = 0; 7 > g; g++)
                        if (exportRoot.chara_display_info[exportRoot._all_pos[g]]) {
                            ...
                            k.chain ? (exportRoot["chara_" + m].chara.body.gotoAndStop(k.face - 1), exportRoot["chara_" + m].x = exportRoot.chara_pos_x[k.pos] + k.offsetx, exportRoot["chara_" + m].y = 170 + k.offsety, exportRoot["chara_" + m].scaleX = exportRoot["chara_" + m].scaleY = k.scale, exportRoot["chara_" + m].visible = !0) : (exportRoot["chara_" + m].visible = !1, exportRoot["chara_b_" + m].visible = !0, exportRoot["chara_b_" + m].chara.body.gotoAndStop(k.face - 1), exportRoot["chara_b_" +
                                m].x = exportRoot.chara_pos_x[k.pos] + k.offsetx, exportRoot["chara_b_" + m].y = 170 + k.offsety, exportRoot["chara_b_" + m].scaleX = exportRoot["chara_b_" + m].scaleY = k.scale)
                        }
                },
                chara_display_check: function(g) {
                    exportRoot.chara_display_info[g.position] = null;
                    for (var k = 0; k < exportRoot._all_pos.length; k++) exportRoot.chara_display_info[exportRoot._all_pos[k]] && g.character_id == exportRoot.chara_display_info[exportRoot._all_pos[k]].id && (exportRoot["chara_" + exportRoot.chara_frame_info[exportRoot.chara_display_info[exportRoot._all_pos[k]].id].id].visible = !1, exportRoot.chara_display_info[exportRoot._all_pos[k]] = null)
                },
                chara_active_set: function(g) {
                    ...
                    g.face = g.face || 1;
                    exportRoot.chara_frame_info[g.character_id] && (m = parseInt(g.offsetx || exportRoot.chara_frame_info[g.character_id].offsetx || 0), y = parseInt(g.offsety || exportRoot.chara_frame_info[g.character_id].offsety || 0), w = g.scale || exportRoot.chara_frame_info[g.character_id].scale || 1);
                    exportRoot["chara_" + u].chara.body.gotoAndStop(g.face -
                        1);
                    ...
                    for (var p = 1; p <= exportRoot.chara_num; p++) exportRoot["chara_b_" + p].visible = !1;
                    for (p = 0; 7 > p; p++)
                        if (exportRoot.chara_display_info[exportRoot._all_pos[p]]) {
                            ...
                            q.chain ? (exportRoot["chara_" + r].chara.body.gotoAndStop(q.face - 1), exportRoot["chara_" +
                                r].x = exportRoot.chara_pos_x[q.pos] + q.offsetx, exportRoot["chara_" + r].y = 170 + q.offsety, exportRoot["chara_" + r].scaleX = exportRoot["chara_" + u].scaleY = q.scale, exportRoot["chara_" + r].visible = !0) : (exportRoot["chara_" + r].visible = !1, exportRoot["chara_b_" + r].visible = !0, exportRoot["chara_b_" + r].chara.body.gotoAndStop(q.face - 1), exportRoot["chara_b_" + r].x = exportRoot.chara_pos_x[q.pos] + q.offsetx, exportRoot["chara_b_" + r].y = 170 + q.offsety, exportRoot["chara_b_" + r].scaleX = exportRoot["chara_b_" + r].scaleY = q.scale)
                        } if (0 ==
                        g.auto) x = !0;
                    else
                        for (p = 0; 7 > p; p++) exportRoot.chara_display_info[exportRoot._all_pos[p]] && (exportRoot.chara_display_info[exportRoot._all_pos[p]].chain = !1);
                ...
                chara_motion_set: function(g, k) {
                    ...
                    else exportRoot.chara_frame_info[g.character_id] && (k = k || exportRoot.chara_frame_info[g.character_id].id || 0), g.movement && exportRoot["chara_" + k].gotoAndPlay(g.movement)
                },
                effect_set: function(g) {
                    ...
                    exportRoot["effect_target_" + m] && (exportRoot["effect_target_" + m].visible = !0, exportRoot["effect_target_" + m].gotoAndStop(g), exportRoot["effect_target_" +
                        m]["eff_" + (g + 1)].gotoAndPlay(0), exportRoot["effect_target_" + m]["eff_" + (g + 1)].gotoAndPlay(k))
                },
                ...
                bg_change: function(g, k) {
                    ...
                    g.match("change") && 0 < g.match("change").length ? (k = g.substr(g.length - 1, g.length), exportRoot._bg_target = (0 == k ? 10 : k) - 1, m.bg_mask.gotoAndPlay("in_out")) : (m.bg_mask.gotoAndPlay(g), m.gotoAndStop(k - 1))
                },
                    ...
                    if (exportRoot.scene_list.length - 1 <= exportRoot.story_point)
                        ...
                        case "main":
                            if ("out" == exportRoot.toggle_flag) exportRoot.toggle_flag = "in", exportRoot.win.gotoAndPlay("in");
                                ...
                                for (var k = 0; 7 > k; k++) exportRoot.chara_display_info[exportRoot._all_pos[k]] && (exportRoot["effect_target_" + exportRoot._all_pos[k]].visible = !1);
                                exportRoot._u.scene_init();
    ...
    n.bootstrapCallback = function(c) {
        ...
        if (0 < n.bootcompsLoaded.length)
            for (var d = 0; d < n.bootcompsLoaded.length; ++d) c(n.bootcompsLoaded[d])
    };
    ...
    n.compositionLoaded = function(c) {
        ...
        for (var d = 0; d <
            n.bootstrapListeners.length; d++) n.bootstrapListeners[d](c)
    };
    ...
    n.makeResponsive = function(c, d, e, z, t) {
        function g() {
            var w = b.properties.width,
                ...
                v = 1;
            if (c)
                if ("width" == d && k == u || "height" == d && m == p) v = y;
                else if (e) 1 == z ? v = Math.min(r, A) : 2 == z && (v = Math.max(r, A));
            else if (u < w || p < x) v = Math.min(r, A);
            t[0].width = w * q * v;
            t[0].height = x * q * v;
